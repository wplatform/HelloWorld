...
public abstract class EntitySystem {
	...
	/**
	 * Called when this EntitySystem is added to an {@link World}.
	 * @param world The {@link World} this system was added to.
	 */
	public void addedToEngine (World world) {
	}

	/**
	 * Called when this EntitySystem is removed from an {@link World}.
	 * @param world The {@link World} the system was removed from.
	 */
	...
	/** Sets whether or not the system should be processed by the {@link World}. */
	...
	final void addedToEngineInternal(World world) {
		this.world = world;
		addedToEngine(world);
	}
	
	final void removedFromEngineInternal(World world) {
		this.world = null;
		removedFromEngine(world);
	}
}
