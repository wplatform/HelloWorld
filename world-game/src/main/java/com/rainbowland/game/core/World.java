...
import com.rainbowland.game.core.ComponentOperationHandler.BooleanInformer;
import com.rainbowland.game.core.SystemManager.SystemListener;
import com.rainbowland.game.signals.Listener;
import com.rainbowland.game.signals.Signal;
import com.rainbowland.game.utils.ImmutableArray;
...
public class World {
	...
	/**
	 * @return immutable array of all entity systems managed by the {@link World}.
	 */
	...
	private class EngineSystemListener implements SystemListener {
		...
		public void systemAdded (EntitySystem system) {
			system.addedToEngineInternal(World.this);
		}

		@Override
		public void systemRemoved (EntitySystem system) {
			system.removedFromEngineInternal(World.this);
		}
	}
