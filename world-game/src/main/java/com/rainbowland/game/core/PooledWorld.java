...
package com.rainbowland.game.core;
...
public class PooledWorld extends World {
	 ...
	 * {@link #PooledWorld(int, int, int, int)} to configure the entity and component pools.
	 */
	public PooledWorld() {
		this(10, 100, 10, 100);
	}
	 ...
	 */
	public PooledWorld(int entityPoolInitialSize, int entityPoolMaxSize, int componentPoolInitialSize, int componentPoolMaxSize) {
		super();
	...
	/** @return Clean {@link Entity} from the Engine pool. In order to add it to the {@link World}, use {@link #addEntity(Entity)}. @{@link Override {@link World#createEntity()}} */
	@Override
	...
	/**
	 * Retrieves a new {@link Component} from the {@link World} pool. It will be placed back in the pool whenever it's removed
