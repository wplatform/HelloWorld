...
package com.rainbowland.game.systems;

import com.rainbowland.game.core.World;
import com.rainbowland.game.core.Entity;
import com.rainbowland.game.core.EntitySystem;
import com.rainbowland.game.core.Family;
...
public abstract class IntervalIteratingSystem extends IntervalSystem {
	...
	public void addedToEngine (World world) {
		entities = world.getEntitiesFor(family);
	}
