...
public class RestInfo extends UpdateMaskObject {

    public UpdateField<Integer> threshold = new UpdateField<>(0, 1);

    public UpdateField<Byte> stateID = new UpdateField<>(0, 2);
