...
public class QuestLog extends UpdateMaskObject {
    public UpdateField<Integer> questID = new UpdateField<>(0, 1);
    public UpdateField<Integer> stateFlags = new UpdateField<>(0, 2);
    public UpdateField<Integer> endTime = new UpdateField<>(0, 3);
    public UpdateField<Integer> acceptTime = new UpdateField<>(0, 4);
    public UpdateField<Integer> objectiveFlags = new UpdateField<>(0, 5);
