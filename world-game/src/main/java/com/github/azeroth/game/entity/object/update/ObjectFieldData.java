...
public class ObjectFieldData extends UpdateMaskObject {
    public UpdateField<Integer> entryId = new UpdateField<>(0, 1);
    public UpdateField<Integer> dynamicFlags = new UpdateField<>(0, 2);
    public UpdateField<Float> scale = new UpdateField<>(0, 3);
    ...
    private int getViewerDependentDynamicFlags(ObjectFieldData objectData, WorldObject obj, Player receiver) {
        ...
        if (unit != null) {
            ...
            if (unitDynFlags.hasFlag((int) UnitDynFlags.TrackUnit.getValue())) {
