...
public class TraitConfig extends UpdateMaskObject {
    public DynamicUpdateField<TraitEntry> entries = new DynamicUpdateField<TraitEntry>(0, 1);
    public UpdateField<Integer> ID = new UpdateField<>(0, 2);
    public updateFieldString name = new updateFieldString(0, 3);
    public UpdateField<Integer> type = new UpdateField<>(4, 5);
    public UpdateField<Integer> skillLineID = new UpdateField<>(4, 6);
    public UpdateField<Integer> chrSpecializationID = new UpdateField<>(4, 7);
    public UpdateField<Integer> combatConfigFlags = new UpdateField<>(8, 9);
    public UpdateField<Integer> localIdentifier = new UpdateField<>(8, 10);
    public UpdateField<Integer> traitSystemID = new UpdateField<>(8, 11);
