...
public class ScaleCurve extends BaseUpdateData<areaTrigger> {
    public UpdateField<Boolean> overrideActive = new UpdateField<Boolean>(0, 1);
    public UpdateField<Integer> startTimeOffset = new UpdateField<Integer>(0, 2);
    public UpdateField<Integer> parameterCurve = new UpdateField<Integer>(0, 3);
