...
public class GameObjectData extends UpdateMaskObject {
    public UpdateField<ArrayList<Integer>> stateWorldEffectIDs = new UpdateField<>(0, 1);
    public DynamicUpdateField<Integer> enableDoodadSets = new DynamicUpdateField<>(0, 2);
    public DynamicUpdateField<Integer> worldEffects = new DynamicUpdateField<>(0, 3);
    public UpdateField<Integer> displayID = new UpdateField<>(0, 4);
    public UpdateField<Integer> spellVisualID = new UpdateField<>(0, 5);
    public UpdateField<Integer> stateSpellVisualID = new UpdateField<>(0, 6);
    public UpdateField<Integer> spawnTrackingStateAnimID = new UpdateField<>(0, 7);
    public UpdateField<Integer> spawnTrackingStateAnimKitID = new UpdateField<>(0, 8);
    public UpdateField<Integer> stateWorldEffectsQuestObjectiveID = new UpdateField<>(0, 9);
    public UpdateField<ObjectGuid> createdBy = new UpdateField<>(0, 10);
    public UpdateField<ObjectGuid> guildGUID = new UpdateField<>(0, 11);
    public UpdateField<Integer> flags = new UpdateField<>(0, 12);
    public UpdateField<Quaternion> parentRotation = new UpdateField<>(0, 13);
    public UpdateField<Integer> factionTemplate = new UpdateField<>(0, 14);
    public UpdateField<Byte> state = new UpdateField<>(0, 15);
    public UpdateField<Byte> typeID = new UpdateField<>(0, 16);
    public UpdateField<Byte> percentHealth = new UpdateField<>(0, 17);
    public UpdateField<Integer> artKit = new UpdateField<>(0, 18);
    public UpdateField<Integer> customParam = new UpdateField<>(0, 19);
    public UpdateField<Integer> level = new UpdateField<>(0, 20);
    public UpdateField<Integer> animGroupInstance = new UpdateField<>(0, 21);
    public UpdateField<Integer> uiWidgetItemID = new UpdateField<>(0, 22);
    public UpdateField<Integer> uiWidgetItemQuality = new UpdateField<>(0, 23);
    public UpdateField<Integer> uiWidgetItemUnknown1000 = new UpdateField<>(0, 24);
