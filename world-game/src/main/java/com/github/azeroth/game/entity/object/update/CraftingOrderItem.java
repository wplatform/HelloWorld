...
public class CraftingOrderItem extends UpdateMaskObject {
    public UpdateField<Long> field_0 = new UpdateField<>(-1, 0);
    public UpdateField<ObjectGuid> itemGUID = new UpdateField<>(-1, 1);
    public UpdateField<ObjectGuid> ownerGUID = new UpdateField<>(-1, 2);
    public UpdateField<Integer> itemID = new UpdateField<>(-1, 3);
    public UpdateField<Integer> quantity = new UpdateField<>(-1, 4);
    public UpdateField<Integer> reagentQuality = new UpdateField<>(-1, 5);
