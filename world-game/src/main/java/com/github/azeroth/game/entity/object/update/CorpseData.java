...
public class CorpseData extends UpdateMaskObject {
    public DynamicUpdateField<ChrCustomizationChoice> customizations = new DynamicUpdateField<ChrCustomizationChoice>(0, 1);

    public UpdateField<Integer> dynamicFlags = new UpdateField<>(0, 2);
    public UpdateField<ObjectGuid> owner = new UpdateField<>(0, 3);
    public UpdateField<ObjectGuid> partyGUID = new UpdateField<>(0, 4);
    public UpdateField<ObjectGuid> guildGUID = new UpdateField<>(0, 5);

    public UpdateField<Integer> displayID = new UpdateField<>(0, 6);

    public UpdateField<Byte> raceID = new UpdateField<>(0, 7);

    public UpdateField<Byte> sex = new UpdateField<>(0, 8);

    public UpdateField<Byte>class =new UpdateField<>(0,9);

    public UpdateField<Integer> flags = new UpdateField<>(0, 10);
    public UpdateField<Integer> factionTemplate = new UpdateField<>(0, 11);

    public UpdateField<Integer> stateSpellVisualKitID = new UpdateField<>(0, 12);
