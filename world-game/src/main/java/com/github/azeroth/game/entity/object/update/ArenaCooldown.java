...
public class ArenaCooldown extends UpdateMaskObject {
    public UpdateField<Integer> spellID = new UpdateField<>(0, 1);
    public UpdateField<Integer> charges = new UpdateField<>(0, 2);
    public UpdateField<Integer> flags = new UpdateField<>(0, 3);
    public UpdateField<Integer> startTime = new UpdateField<>(0, 4);
    public UpdateField<Integer> endTime = new UpdateField<>(0, 5);
    public UpdateField<Integer> nextChargeTime = new UpdateField<>(0, 6);
    public UpdateField<Byte> maxCharges = new UpdateField<>(0, 7);
