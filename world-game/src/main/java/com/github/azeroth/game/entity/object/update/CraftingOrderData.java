...
public class CraftingOrderData extends UpdateMaskObject {
    public DynamicUpdateField<CraftingOrderItem> reagents = new DynamicUpdateField<CraftingOrderItem>(0, 1);
    public UpdateField<Integer> field_0 = new UpdateField<>(0, 2);
    public UpdateField<Long> orderID = new UpdateField<>(0, 3);
    public UpdateField<Integer> skillLineAbilityID = new UpdateField<>(0, 4);
    public UpdateField<Byte> orderState = new UpdateField<>(5, 6);
    public UpdateField<Byte> orderType = new UpdateField<>(5, 7);
    public UpdateField<Byte> minQuality = new UpdateField<>(5, 8);
    public UpdateField<Long> expirationTime = new UpdateField<>(5, 9);
    public UpdateField<Long> claimEndTime = new UpdateField<>(10, 11);
    public UpdateField<Long> tipAmount = new UpdateField<>(10, 12);
    public UpdateField<Long> consortiumCut = new UpdateField<>(10, 13);
    public UpdateField<Integer> flags = new UpdateField<>(10, 14);
    public UpdateField<ObjectGuid> customerGUID = new UpdateField<>(15, 16);
    public UpdateField<ObjectGuid> customerAccountGUID = new UpdateField<>(15, 17);
    public UpdateField<ObjectGuid> crafterGUID = new UpdateField<>(15, 18);
    public UpdateField<ObjectGuid> personalCrafterGUID = new UpdateField<>(15, 19);
