...
public interface UpdateFieldFlags {
    ...
    int UF_FLAG_NONE = 0x000;
    int UF_FLAG_PUBLIC = 0x001;
    int UF_FLAG_PRIVATE = 0x002;
    int UF_FLAG_OWNER = 0x004;
    int UF_FLAG_ITEM_OWNER = 0x008;
    int UF_FLAG_SPECIAL_INFO = 0x010;
    int UF_FLAG_PARTY_MEMBER = 0x020;
    int UF_FLAG_UNIT_ALL = 0x040;
    int UF_FLAG_DYNAMIC = 0x080;
    int UF_FLAG_0x100 = 0x100;
    int UF_FLAG_URGENT = 0x200;
    int UF_FLAG_URGENT_SELF_ONLY = 0x400;
