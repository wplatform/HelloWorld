...
public class BattlePayDataStoreMgr 
{
	...
	private void loadDisplayInfos()
	{
		...
		do
		{
			...
			if (!(getDisplayInfos().containsKey(visualInfo.getDisplayInfoEntry()) && (var bpayDisplayInfo = getDisplayInfos().get(visualInfo.getDisplayInfoEntry())) == var bpayDisplayInfo))
			{
				continue;
			}
