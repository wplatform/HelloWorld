...
{
	private final java.util.concurrent.ConcurrentHashMap<(int serviceHash, int methodId), WorldServiceHandler> serviceHandlers;

	private WorldServiceManager()
	{
		serviceHandlers = new java.util.concurrent.ConcurrentHashMap<(int serviceHash, int methodId), WorldServiceHandler>();
