...
import com.github.mmo.game.networking.packet.AuraDataInfo;
import com.github.mmo.game.networking.packet.AuraInfo;
import com.github.mmo.game.networking.packet.AuraUpdate;
...
public class AuraApplication
{
	...
	{
		return flags.HasAnyFlag(AuraFlags.positive);
	}
	...
	{
		return flags.HasAnyFlag(AuraFlags.NOCASTER);
	}
