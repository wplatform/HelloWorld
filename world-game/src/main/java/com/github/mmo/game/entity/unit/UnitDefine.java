...
public interface UnitDefine {
    ...
    // synonyms
    int UNIT_MOD_STAT_START = UnitMods.UNIT_MOD_STAT_STRENGTH.ordinal();
    int UNIT_MOD_STAT_END = UnitMods.UNIT_MOD_STAT_INTELLECT.ordinal() + 1;
    int UNIT_MOD_RESISTANCE_START = UnitMods.UNIT_MOD_ARMOR.ordinal();
