...
public class DamageInfo
{
	...
	public DamageInfo(CalcDamageInfo dmgInfo)
	{
		...
		if (dmgInfo.getHitInfo().HasAnyFlag(hitInfo.PartialAbsorb.getValue() | hitInfo.FullAbsorb.getValue()))
		{
			hitMask = ProcFlagsHit.forValue(hitMask.getValue() | ProcFlagsHit.absorb.getValue());
		}

		if (dmgInfo.getHitInfo().HasAnyFlag(hitInfo.FullResist))
		{
		...
		var damageNullified = dmgInfo.getHitInfo().HasAnyFlag(hitInfo.FullAbsorb.getValue() | hitInfo.FullResist.getValue()) || hitMask.HasAnyFlag(ProcFlagsHit.Immune.getValue() | ProcFlagsHit.fullBlock.getValue());
