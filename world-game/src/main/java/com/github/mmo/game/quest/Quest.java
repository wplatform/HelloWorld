...
import com.github.mmo.game.quest.enums.QuestSpecialFlag;
import com.github.mmo.game.service.model.quest.QuestConditionalText;
import com.github.mmo.game.service.model.quest.QuestRewardDisplaySpell;
...
public class Quest
{
	...
	{
		return getSpecialFlags().HasAnyFlag(QuestSpecialFlag.repeatable);
	}
	...
	{
		return getSpecialFlags().HasAnyFlag(QuestSpecialFlag.Monthly);
	}
	...
	{
		return getSpecialFlags().HasAnyFlag(QuestSpecialFlag.DfQuest);
	}
	...
	private QuestFlag flags = questFlags.values()[0];
	public QuestFlag getFlags()
	{
		return flags;
	}
	public void setFlags(QuestFlag value)
	{
		flags = value;
	}
	...
	private QuestSpecialFlag specialFlags = QuestSpecialFlag.values()[0];
	public QuestSpecialFlag getSpecialFlags()
	{
		return specialFlags;
	}
	public void setSpecialFlags(QuestSpecialFlag value)
	{
		specialFlags = value;
	}
	...
	public void loadQuestTemplateAddon(SQLFields fields)
	{
		...
		setSpecialFlags(QuestSpecialFlag.forValue(fields.<Byte>Read(17)));
		setScriptId(global.getObjectMgr().getScriptId(fields.<String>Read(18)));

		if (getSpecialFlags().HasAnyFlag(QuestSpecialFlag.autoAccept))
		{
	...
	{
		setSpecialFlags(QuestSpecialFlag.forValue(getSpecialFlags().getValue() | flag.getValue()));
	}
