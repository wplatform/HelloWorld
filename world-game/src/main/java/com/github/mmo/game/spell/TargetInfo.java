...
import com.github.mmo.game.entity.unit.SpellNonMeleeDamage;
import com.github.mmo.game.entity.unit.Unit;
import com.github.mmo.game.scripting.interfaces.iplayer.IPlayerOnDealDamage;
	...
	public void doDamageAndTriggers(Spell spell)
	{
		...
		if (caster != null)
		{
			...
			if (canEffectTrigger)
			{
				...
				if (caster.isPlayer() && procSpellType.HasAnyFlag(ProcFlagsSpellType.damage.getValue() | ProcFlagsSpellType.NoDmgHeal.getValue()))
				{
