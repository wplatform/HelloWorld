...
import com.github.mmo.defines.ReputationRank;
import com.github.mmo.game.entity.player.Player;
import com.github.mmo.game.networking.packet.reputation.ForcedReaction;
import com.github.mmo.game.networking.packet.reputation.SetForcedReactions;
...
public class ReputationMgr
{
	...
	public final void setAtWar(int repListID, boolean on)
	{
		...
		if (factionState.flags.HasAnyFlag(ReputationFlags.hidden.getValue() | ReputationFlags.header.getValue()))
		{
			return;
		}
	...
	private void setInactive(FactionState faction, boolean inactive)
	{
		...
		if (faction.flags.HasAnyFlag(ReputationFlags.hidden.getValue() | ReputationFlags.header.getValue()) || !faction.flags.hasFlag(ReputationFlags.Visible))
		{
			return;
		}
