...
import com.github.mmo.game.networking.packet.ChannelListResponse;
...
public class Channel
{
	...
	private final TeamFaction channelTeam;
	...
	public channel(ObjectGuid guid, int channelId, TeamFaction team)
	{
	...
	public channel(ObjectGuid guid, int channelId, TeamFaction team, AreaTableRecord zoneEntry)
	{
	...
	public channel(ObjectGuid guid, String name, TeamFaction team)
	{
		this(guid, name, team, "");
	}
	...
	public channel(ObjectGuid guid, String name, TeamFaction team, String banList)
	{
	...
	{
		return channelFlags.HasAnyFlag(flag);
	}
