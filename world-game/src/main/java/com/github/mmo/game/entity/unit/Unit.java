...
//			}
    ...
    public final boolean isInPartyWith(Unit unit) {
        ...
        } else if ((u2.isTypeId(TypeId.PLAYER) && u1.isTypeId(TypeId.UNIT) && u1.toCreature().getTemplate().typeFlags.hasFlag(CreatureTypeFlags.TreatAsRaidUnit)) || (u1.isTypeId(TypeId.PLAYER) && u2.isTypeId(TypeId.UNIT) && u2.toCreature().getTemplate().typeFlags.hasFlag(CreatureTypeFlags.TreatAsRaidUnit))) {
            return true;
        }
