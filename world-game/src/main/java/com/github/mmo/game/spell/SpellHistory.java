...
import com.github.mmo.game.scripting.interfaces.iplayer.IPlayerOnChargeRecoveryTimeStart;
import com.github.mmo.game.scripting.interfaces.iplayer.IPlayerOnCooldownEnd;
import com.github.mmo.game.scripting.interfaces.iplayer.IPlayerOnCooldownStart;
...
public class SpellHistory
{
	...
	{
		if (spellInfo.getPreventionType().HasAnyFlag(SpellPreventionType.Silence))
		{
