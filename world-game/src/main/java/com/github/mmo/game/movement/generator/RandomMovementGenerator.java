...
public class RandomMovementGenerator extends MovementGeneratorMedium<Creature>
{
	...
	public void doFinalize(Creature owner, boolean active, boolean movementInform)
	{
		...
		com.github.mmo.game.ai.CreatureAI ai;
		tangible.OutObject<com.github.mmo.game.ai.CreatureAI> tempOut_ai = new tangible.OutObject<com.github.mmo.game.ai.CreatureAI>();
