...
public class UnitData extends BaseUpdateData<unit> {
    ...
    public UpdateField<Integer> displayID = new UpdateField<Integer>(0, 5);
    public UpdateField<Integer> stateSpellVisualID = new UpdateField<Integer>(0, 6);
    public UpdateField<Integer> stateAnimID = new UpdateField<Integer>(0, 7);
    public UpdateField<Integer> stateAnimKitID = new UpdateField<Integer>(0, 8);
    public UpdateField<Integer> stateWorldEffectsQuestObjectiveID = new UpdateField<Integer>(0, 9);
    public UpdateField<Integer> spellOverrideNameID = new UpdateField<Integer>(0, 10);
    ...
    public UpdateField<Long> battlePetDBID = new UpdateField<Long>(0, 21);
    public UpdateField<UnitChannel> channelData = new UpdateField<UnitChannel>(0, 22);
    public UpdateField<Byte> spellEmpowerStage = new UpdateField<Byte>(0, 23);
    public UpdateField<Integer> summonedByHomeRealm = new UpdateField<Integer>(0, 24);
    public UpdateField<Byte> race = new UpdateField<Byte>(0, 25);
    public UpdateField<Byte> classId = new UpdateField<Byte>(0, 26);
    public UpdateField<Byte> playerClassId = new UpdateField<Byte>(0, 27);
    public UpdateField<Byte> sex = new UpdateField<Byte>(0, 28);
    public UpdateField<Byte> displayPower = new UpdateField<Byte>(0, 29);
    public UpdateField<Integer> overrideDisplayPowerID = new UpdateField<Integer>(0, 30);
    public UpdateField<Long> health = new UpdateField<Long>(0, 31);
    public UpdateField<Long> maxHealth = new UpdateField<Long>(32, 33);
    public UpdateField<Integer> level = new UpdateField<Integer>(32, 34);
    public UpdateField<Integer> effectiveLevel = new UpdateField<Integer>(32, 35);
    public UpdateField<Integer> contentTuningID = new UpdateField<Integer>(32, 36);
    public UpdateField<Integer> scalingLevelMin = new UpdateField<Integer>(32, 37);
    public UpdateField<Integer> scalingLevelMax = new UpdateField<Integer>(32, 38);
    public UpdateField<Integer> scalingLevelDelta = new UpdateField<Integer>(32, 39);
    public UpdateField<Integer> scalingFactionGroup = new UpdateField<Integer>(32, 40);
    public UpdateField<Integer> scalingHealthItemLevelCurveID = new UpdateField<Integer>(32, 41);
    public UpdateField<Integer> scalingDamageItemLevelCurveID = new UpdateField<Integer>(32, 42);
    public UpdateField<Integer> factionTemplate = new UpdateField<Integer>(32, 43);
    public UpdateField<Integer> flags = new UpdateField<Integer>(32, 44);
    public UpdateField<Integer> flags2 = new UpdateField<Integer>(32, 45);
    public UpdateField<Integer> flags3 = new UpdateField<Integer>(32, 46);
    public UpdateField<Integer> auraState = new UpdateField<Integer>(32, 47);
    public UpdateField<Integer> rangedAttackRoundBaseTime = new UpdateField<Integer>(32, 48);
    public UpdateField<Float> boundingRadius = new UpdateField<Float>(32, 49);
    public UpdateField<Float> combatReach = new UpdateField<Float>(32, 50);
    public UpdateField<Float> displayScale = new UpdateField<Float>(32, 51);
    public UpdateField<Integer> creatureFamily = new UpdateField<Integer>(32, 52);
    public UpdateField<Integer> creatureType = new UpdateField<Integer>(32, 53);
    public UpdateField<Integer> nativeDisplayID = new UpdateField<Integer>(32, 54);
    public UpdateField<Float> nativeXDisplayScale = new UpdateField<Float>(32, 55);
    public UpdateField<Integer> mountDisplayID = new UpdateField<Integer>(32, 56);
    public UpdateField<Integer> cosmeticMountDisplayID = new UpdateField<Integer>(32, 57);
    public UpdateField<Float> minDamage = new UpdateField<Float>(32, 58);
    public UpdateField<Float> maxDamage = new UpdateField<Float>(32, 59);
    public UpdateField<Float> minOffHandDamage = new UpdateField<Float>(32, 60);
    public UpdateField<Float> maxOffHandDamage = new UpdateField<Float>(32, 61);
    public UpdateField<Byte> standState = new UpdateField<Byte>(32, 62);
    public UpdateField<Byte> petTalentPoints = new UpdateField<Byte>(32, 63);
    public UpdateField<Byte> visFlags = new UpdateField<Byte>(64, 65);
    public UpdateField<Byte> animTier = new UpdateField<Byte>(64, 66);
    public UpdateField<Integer> petNumber = new UpdateField<Integer>(64, 67);
    public UpdateField<Integer> petNameTimestamp = new UpdateField<Integer>(64, 68);
    public UpdateField<Integer> petExperience = new UpdateField<Integer>(64, 69);
    public UpdateField<Integer> petNextLevelExperience = new UpdateField<Integer>(64, 70);
    public UpdateField<Float> modCastingSpeed = new UpdateField<Float>(64, 71);
    public UpdateField<Float> modCastingSpeedNeg = new UpdateField<Float>(64, 72);
    public UpdateField<Float> modSpellHaste = new UpdateField<Float>(64, 73);
    public UpdateField<Float> modHaste = new UpdateField<Float>(64, 74);
    public UpdateField<Float> modRangedHaste = new UpdateField<Float>(64, 75);
    public UpdateField<Float> modHasteRegen = new UpdateField<Float>(64, 76);
    public UpdateField<Float> modTimeRate = new UpdateField<Float>(64, 77);
    public UpdateField<Integer> createdBySpell = new UpdateField<Integer>(64, 78);
    public UpdateField<Integer> emoteState = new UpdateField<Integer>(64, 79);
    public UpdateField<Integer> baseMana = new UpdateField<Integer>(64, 80);
    public UpdateField<Integer> baseHealth = new UpdateField<Integer>(64, 81);
    public UpdateField<Byte> sheatheState = new UpdateField<Byte>(64, 82);
    public UpdateField<Byte> pvpFlags = new UpdateField<Byte>(64, 83);
    public UpdateField<Byte> petFlags = new UpdateField<Byte>(64, 84);
    public UpdateField<Byte> shapeshiftForm = new UpdateField<Byte>(64, 85);
    public UpdateField<Integer> attackPower = new UpdateField<Integer>(64, 86);
    public UpdateField<Integer> attackPowerModPos = new UpdateField<Integer>(64, 87);
    public UpdateField<Integer> attackPowerModNeg = new UpdateField<Integer>(64, 88);
    public UpdateField<Float> attackPowerMultiplier = new UpdateField<Float>(64, 89);
    public UpdateField<Integer> rangedAttackPower = new UpdateField<Integer>(64, 90);
    public UpdateField<Integer> rangedAttackPowerModPos = new UpdateField<Integer>(64, 91);
    public UpdateField<Integer> rangedAttackPowerModNeg = new UpdateField<Integer>(64, 92);
    public UpdateField<Float> rangedAttackPowerMultiplier = new UpdateField<Float>(64, 93);
    public UpdateField<Integer> mainHandWeaponAttackPower = new UpdateField<Integer>(64, 94);
    public UpdateField<Integer> offHandWeaponAttackPower = new UpdateField<Integer>(64, 95);
    public UpdateField<Integer> rangedWeaponAttackPower = new UpdateField<Integer>(96, 97);
    public UpdateField<Integer> setAttackSpeedAura = new UpdateField<Integer>(96, 98);
    public UpdateField<Float> lifesteal = new UpdateField<Float>(96, 99);
    public UpdateField<Float> minRangedDamage = new UpdateField<Float>(96, 100);
    public UpdateField<Float> maxRangedDamage = new UpdateField<Float>(96, 101);
    public UpdateField<Float> manaCostMultiplier = new UpdateField<Float>(96, 102);
    public UpdateField<Float> maxHealthModifier = new UpdateField<Float>(96, 103);
    public UpdateField<Float> hoverHeight = new UpdateField<Float>(96, 104);
    public UpdateField<Integer> minItemLevelCutoff = new UpdateField<Integer>(96, 105);
    public UpdateField<Integer> minItemLevel = new UpdateField<Integer>(96, 106);
    public UpdateField<Integer> maxItemLevel = new UpdateField<Integer>(96, 107);
    public UpdateField<Integer> azeriteItemLevel = new UpdateField<Integer>(96, 108);
    public UpdateField<Integer> wildBattlePetLevel = new UpdateField<Integer>(96, 109);
    public UpdateField<Integer> battlePetCompanionExperience = new UpdateField<Integer>(96, 110);
    public UpdateField<Integer> battlePetCompanionNameTimestamp = new UpdateField<Integer>(96, 111);
    public UpdateField<Integer> interactSpellID = new UpdateField<Integer>(96, 112);
    public UpdateField<Integer> scaleDuration = new UpdateField<Integer>(96, 113);
    public UpdateField<Integer> looksLikeMountID = new UpdateField<Integer>(96, 114);
    public UpdateField<Integer> looksLikeCreatureID = new UpdateField<Integer>(96, 115);
    public UpdateField<Integer> lookAtControllerID = new UpdateField<Integer>(96, 116);
    public UpdateField<Integer> perksVendorItemID = new UpdateField<Integer>(96, 117);
    public UpdateField<Integer> taxiNodesID = new UpdateField<Integer>(96, 118);
    public UpdateField<ObjectGuid> guildGUID = new UpdateField<ObjectGuid>(96, 119);
    public UpdateField<Integer> flightCapabilityID = new UpdateField<Integer>(96, 120);
    public UpdateField<Integer> silencedSchoolMask = new UpdateField<Integer>(96, 121);
    public UpdateField<ObjectGuid> nameplateAttachToGUID = new UpdateField<ObjectGuid>(96, 122); // When set, nameplate of this unit will instead appear on that object
    public UpdateFieldArray<Integer> npcFlags = new UpdateFieldArray<Integer>(2, 123, 124);
    public UpdateFieldArray<Integer> power = new UpdateFieldArray<Integer>(7, 126, 127);
    public UpdateFieldArray<Integer> maxPower = new UpdateFieldArray<Integer>(7, 126, 134);
    public UpdateFieldArray<Float> powerRegenFlatModifier = new UpdateFieldArray<Float>(7, 126, 141);
    public UpdateFieldArray<Float> powerRegenInterruptedFlatModifier = new UpdateFieldArray<Float>(7, 126, 148);
    public UpdateFieldArray<VisibleItem> virtualItems = new UpdateFieldArray<VisibleItem>(3, 155, 156);
    public UpdateFieldArray<Integer> attackRoundBaseTime = new UpdateFieldArray<Integer>(2, 159, 160);
    public UpdateFieldArray<Integer> stats = new UpdateFieldArray<Integer>(4, 162, 163);
    public UpdateFieldArray<Integer> statPosBuff = new UpdateFieldArray<Integer>(4, 162, 167);
    public UpdateFieldArray<Integer> statNegBuff = new UpdateFieldArray<Integer>(4, 162, 171);
    public UpdateFieldArray<Integer> resistances = new UpdateFieldArray<Integer>(7, 175, 176);
    public UpdateFieldArray<Integer> bonusResistanceMods = new UpdateFieldArray<Integer>(7, 175, 183);
    public UpdateFieldArray<Integer> manaCostModifier = new UpdateFieldArray<Integer>(7, 175, 190);
    ...
    public final void writeCreate(WorldPacket data, UpdateFieldFlag fieldVisibilityFlags, Unit owner, Player receiver) {
        ...
        data.writeInt32(stateWorldEffectIDs.getValue().size());
        data.writeInt32(stateWorldEffectsQuestObjectiveID);
        data.writeInt32(spellOverrideNameID);

        for (var i = 0; i < stateWorldEffectIDs.getValue().size(); ++i) {
            data.writeInt32(stateWorldEffectIDs.getValue().get(i));
        }
    ...
    public final void writeUpdate(WorldPacket data, UpdateMask changesMask, boolean ignoreNestedChangesMask, Unit owner, Player receiver) {
        ...
        if (changesMask.get(0)) {
            if (changesMask.get(1)) {
                data.writeBits(stateWorldEffectIDs.getValue().size(), 32);
