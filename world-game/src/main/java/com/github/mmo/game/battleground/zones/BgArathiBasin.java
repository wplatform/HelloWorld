...
class BgArathiBasin extends Battleground
{
	...
	*/
	...
	public void startingEventCloseDoors()
	{
		...
		_NodeOccupied((byte)ABBattlegroundNodes.SPIRITALIANCE, TeamFaction.Alliance);
		_NodeOccupied((byte)ABBattlegroundNodes.SPIRITHORDE, TeamFaction.Horde);
	}
	...
	private void _NodeOccupied(byte node, TeamFaction team)
	{
		...
		if (trigger)
		{
			trigger.faction = team == TeamFaction.Alliance ? 84 : 83;
