...
import com.rainbowland.core.utils.reflect.ArrayReflection;
 ...
 * @author Arni Arent
 */
public class Array<E> implements ImmunityArray<E> {
	...
	public Array(Class<E> type, int capacity) {
	 ...
	 */
	public boolean removeAll(ImmunityArray<E> bag) {
	 ...
	 */
	public void addAll(ImmunityArray<E> items) {
