...
import static com.rainbowland.core.utils.reflect.ClassReflection.getMethod;
import static com.rainbowland.core.utils.reflect.ClassReflection.isInstance;

public final class ReflectionUtil {
	private static final Class<?>[] PARAM_ENTITY = {Entity.class};
	private static final Class<?>[] PARAM_ID = {int.class};
	private static final Class<?>[] PARAM_IDS = {IntArray.class};
