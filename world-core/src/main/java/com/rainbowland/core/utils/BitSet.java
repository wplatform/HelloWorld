...
import com.rainbowland.core.ComponentManager;
import com.rainbowland.core.World;
import com.rainbowland.core.EntityManager;
 ...
 *
 * @see EntityManager#registerEntityStore(BitSet)
 */
public class BitSet {
	 ...
	 * {@link IntArray} is reset before the bits are transposed.
	 *
	 * @param out decoded ints end up here
	 * @return Same as out
	 */
	public IntArray toIntBag(IntArray out) {
		if (isEmpty()) {
			out.setSize(0);
			return out;
		}
	 ...
	 * destination{@link IntArray} is reset before the bits are
	 * transposed.
	 *
	 * @param out decoded ints end up here
	 * @return Same as out
	 */
	public IntArray toIntBagIdCid(ComponentManager cm, IntArray out) {
		if (isEmpty()) {
			out.setSize(0);
			return out;
		}
	...
	private int prepareBag(IntArray out, int elementsPerEntry) {
