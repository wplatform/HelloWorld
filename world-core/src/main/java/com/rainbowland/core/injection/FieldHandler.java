...
public class FieldHandler {
	...
	protected Array<FieldResolver> fieldResolvers;
	 ...
	 */
	public FieldHandler(InjectionCache cache, Array<FieldResolver> fieldResolvers) {
		this.cache = cache;
	 ...
	 * and {@link Manager} types registered in the {@link World}
	 * {@link Wire}.
	 *
	 * @param cache used for better reflection-speed.
	 * @see ArtemisFieldResolver
	...
	public FieldHandler(InjectionCache cache) {
		this.fieldResolvers = new Array(FieldResolver.class);
		this.cache = cache;
	...
	public Array<FieldResolver> getFieldResolvers() {
