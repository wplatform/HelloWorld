...
import com.rainbowland.core.EntityTransmuter.TransmuteOperation;
...
public class ArchetypeBuilder {
	private final Array<Class<? extends Component>> classes;
	...
	public ArchetypeBuilder(Archetype parent) {
		classes = new Array<Class<? extends Component>>();
		if (parent == null)
			return;
