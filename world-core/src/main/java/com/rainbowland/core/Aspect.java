...
public class Aspect {
	...
	public static class Builder {
		private final Array<Class<? extends Component>> allTypes;
		private final Array<Class<? extends Component>> exclusionTypes;
		private final Array<Class<? extends Component>> oneTypes;

		private Builder() {
			allTypes = new Array<Class<? extends Component>>();
			exclusionTypes = new Array<Class<? extends Component>>();
			oneTypes = new Array<Class<? extends Component>>();
		}
		...
		private static void associate(ComponentTypeFactory tf, Array<Class<? extends Component>> types, BitSet componentBits) {
			for (Class<? extends Component> t : types) {
		...
		private StringBuilder append(Array<Class<? extends Component>> types) {
