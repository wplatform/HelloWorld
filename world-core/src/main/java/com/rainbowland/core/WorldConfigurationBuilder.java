...
import com.rainbowland.core.annotations.UnstableApi;
import com.rainbowland.core.injection.CachedInjector;
import com.rainbowland.core.injection.FieldHandler;
import com.rainbowland.core.injection.FieldResolver;
import com.rainbowland.core.injection.InjectionCache;
import com.rainbowland.core.utils.Array;
import com.rainbowland.core.utils.IntArray;
import com.rainbowland.core.utils.Sort;
...
public class WorldConfigurationBuilder {
    private Array<ConfigurationElement<? extends BaseSystem>> systems;
    private Array<ConfigurationElement<? extends FieldResolver>> fieldResolvers;
    private Array<ConfigurationElement<? extends ArtemisPlugin>> plugins;
     ...
     * all {@link EntitySubscription.SubscriptionListener#removed(IntArray) listeners} have been notified - regardless
     * of removal method.
     * <p>
     ...
     */
    @SuppressWarnings("unchecked")
    private boolean containsType(Array items, Class type) {
        for (ConfigurationElement<?> registration : (Array<ConfigurationElement<?>>) items) {
     ...
     */
    @SuppressWarnings("unchecked")
    private boolean anyAssignableTo(Array items, Class type) {
        for (ConfigurationElement<?> registration : (Array<ConfigurationElement<?>>) items) {
