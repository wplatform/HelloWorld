...
public abstract class EntitySystem extends BaseEntitySystem
	...
	private WildArray<Entity> entities = new WildArray(Entity.class);
	...
	@Override
	public final void inserted(IntArray entities) {
	...
	@Override
	public final void removed(IntArray entities) {
		shouldSyncEntities = true;
	...
	public Array<Entity> getEntities() {
		if (shouldSyncEntities) {
			...
			entities.setSize(0);
			IntArray entityIds = subscription.getEntities();
