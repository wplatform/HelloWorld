...
public abstract class SystemInvocationStrategy {
	 ...
	 */
	protected void setSystems(Array<BaseSystem> systems) {
	 ...
	 */
	@Deprecated
	protected final void process(Array<BaseSystem> systems) {
	...
	public boolean isEnabled(BaseSystem system) {
		...
		ImmunityArray<BaseSystem> systems = world.getSystems();
