...
import com.rainbowland.core.utils.reflect.Constructor;
...
public class ComponentTypeFactory {
	...
	private final Array<ComponentTypeListener> listeners
			= new Array<ComponentTypeListener>();
	
	/** Index of this component type in componentTypes. */
	final Array<ComponentType> types = new Array(ComponentType.class);
	...
	public interface ComponentTypeListener {
		void initialize(Array<ComponentType> registered);
