...
import com.rainbowland.core.utils.IntDeque;
...
public class EntityManager extends BaseSystem {
	...
	private int nextId;
	private Array<BitSet> entityBitVectors = new Array<BitSet>(BitSet.class);

	/**
	 * Creates a new EntityManager Instance.
	 */
	protected EntityManager(int initialContainerSize) {
		entities = new Array<Entity>(initialContainerSize);
	...
	void clean(IntArray pendingDeletion) {
	...
	public void registerEntityStore(BitSet bv) {
