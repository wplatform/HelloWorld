...
public enum DbcObjects {
    ...
    Emote(com.github.mmo.dbc.domain.Emote.class),
    ...
    ItemDamageOneHand(com.github.mmo.dbc.domain.ItemDamageOneHand.class),
    ...
    MountXDisplay(com.github.mmo.dbc.domain.MountXDisplay.class),
    Movie(Movie.class),
    ...
    RewardPackXItem(com.github.mmo.dbc.domain.RewardPackXItem.class),
    ...
    Scenario(com.github.mmo.dbc.domain.Scenario.class),
