...
public enum SpellCustomErrors {
    ...
    SPELL_CUSTOM_ERROR_TARGET_CANNOT_ALREADY_HAVE_ORB_OF_POWER, // Target cannot already have a Orb of Power.
    ...
    SPELL_CUSTOM_ERROR_YOU_ARE_NOT_THE_CORRECT_RANK_TO_USE_THIS_ITEM, // You are not the correct Rank to use this item.
    ...
    SPELL_CUSTOM_ERROR_THERES_NOTHING_FURTHER_YOU_CAN_LEARN, // There's nothing further you can learn.
    ...
    SPELL_CUSTOM_ERROR_REQUIRES_MORRISONS_MASTER_KEY, // Requires Morrison's Master Key.
    ...
    SPELL_CUSTOM_ERROR_MUST_BE_AFFECTED_BY_SPIRIT_POWDER, // You must be affected by the Spirit Powder to take the phylactery.
    ...
    SPELL_CUSTOM_ERROR_ONLY_OTHER_HIVEMIND_MEMBERS_MAY_JOIN, // Only other members of their Hivemind may join with them.
    SPELL_CUSTOM_ERROR_NO_VALID_FLASK_PRESENT, // No valid flask present.
    SPELL_CUSTOM_ERROR_NO_WILD_IMPS_TO_SACRIFICE, // There are no Wild Imps to sacrifice.
    SPELL_CUSTOM_ERROR_YOU_ARE_CARRYING_TOO_MUCH_IRON, // You are carrying too much Iron
    SPELL_CUSTOM_ERROR_YOU_HAVE_NO_IRON_TO_COLLECT, // You have no Iron to collect
    SPELL_CUSTOM_ERROR_YOU_HAVE_NO_WILD_IMPS, // You have no available Wild Imps.
    SPELL_CUSTOM_ERROR_NEEDS_REPAIRS, // Needs repairs.
    SPELL_CUSTOM_ERROR_YOU_ARE_CARRYING_TOO_MUCH_WOOD, // You're carrying too much wood.
    SPELL_CUSTOM_ERROR_YOU_ARE_ALREADY_CARRYING_REPAIR_PARTS, // You're already carrying repair parts.
    SPELL_CUSTOM_ERROR_YOU_HAVE_NOT_UNLOCKED_FLIGHT_WHISTLE_FOR_ZONE, // You have not unlocked the Flight Whistle for this zone.
    SPELL_CUSTOM_ERROR_THERE_ARE_NO_UNLOCKED_FLIGHT_POINTS_NEARBY, // There are no unlocked flight points nearby to take you to.
    SPELL_CUSTOM_ERROR_YOU_MUST_HAVE_A_FELGUARD, // You must have a Felguard.
    SPELL_CUSTOM_ERROR_TARGET_HAS_NO_FESTERING_WOUNDS, // The target has no Festering Wounds.
    SPELL_CUSTOM_ERROR_YOU_DONT_HAVE_DEADLY_OR_WOUND_POISON_ACTIVE, // You do not have Deadly Poison or Wound Poison active.
    SPELL_CUSTOM_ERROR_CANNOT_READ_SOLDIER_DOG_TAG_WITHOUT_HEADLAMP_ON, // You cannot read the soldier's dog tag without your headlamp on.
    SPELL_CUSTOM_ERROR_YOU_HAVE_NO_WOOD_TO_COLLECT, // You have no Wood to collect.
    SPELL_CUSTOM_ERROR_YOU_ARE_NOT_WEARING_A_SHIRT, // You are not wearing a shirt!
    SPELL_CUSTOM_ERROR_TARGET_MUST_BE_DEAD, // Target must be dead.
    SPELL_CUSTOM_ERROR_YOUR_TARGET_IS_ALREADY_EMBIGGIFIED, // Your target is already embiggified.
    SPELL_CUSTOM_ERROR_YOU_MUST_TARGET_A_SINISTER_GLADIATOR_ITEM, // You must target a Sinister Gladiator's item to upgrade.
    SPELL_CUSTOM_ERROR_THIS_ITEM_LEVEL_IS_TOO_HIGH_FOR_THIS_UPGRADE, // This item's level is too high for this upgrade.
    SPELL_CUSTOM_ERROR_THE_BALLISTA_CANNOT_BE_USED_WHILE_ON_FIRE, // The ballista cannot be used while on fire.
    SPELL_CUSTOM_ERROR_YOU_MUST_TARGET_A_DREAD_GLADIATOR_ITEM, // You must target a Dread Gladiator's item to upgrade.
    SPELL_CUSTOM_ERROR_YOU_DO_KNOT_KNOW_HOW_TO_TAME_BLOOD_BEASTS, // You do not know how to tame Blood Beasts.
    SPELL_CUSTOM_ERROR_CAN_ONLY_BE_USED_IN_THE_EVENING, // Can only be used in the evening.
    SPELL_CUSTOM_ERROR_REQUIRES_PAKU_TO_BE_YOUR_CHOSEN_LOA, // Requires Pa'ku to be your chosen loa.
    SPELL_CUSTOM_ERROR_REQUIRES_VIGOR_ENGAGED, // Requires V.I.G.O.R. Engaged.
    SPELL_CUSTOM_ERROR_YOUR_TARGET_IS_NOT_HUNGRY, // Your target is not hungry.
    SPELL_CUSTOM_ERROR_YOU_CAN_ONLY_HAVE_ON_TREASURE_MAP_MISSION, // You can only have one treasure map mission at a time.
    SPELL_CUSTOM_ERROR_YOU_ALREADY_HAVE_A_SILAS_SPHERE_OF_TRANSMUTATION, // You already have a Silas' Sphere of Transmuation.
    SPELL_CUSTOM_ERROR_YOU_DO_NOT_HAVE_THE_MALLET_OF_THUNDEROUS_SKINS, // You do not have the Mallet of Thunderous Skins.
    SPELL_CUSTOM_ERROR_YOU_MUST_HAVE_AN_OPEN_STABLE_SLOT, // You must have an open stable slot.
    SPELL_CUSTOM_ERROR_DOES_NOT_WORK_ON_CRITTERS, // Does not work on critters.
    SPELL_CUSTOM_ERROR_CAN_ONLY_BE_USED_ON_HATI, // Can only be used on Hati.
    SPELL_CUSTOM_ERROR_YOU_ALREADY_HAVE_IWENS_ENCHANTING_ROD, // You already have an Iwen's Enchanting Rod.
    SPELL_CUSTOM_ERROR_YOU_ALREADY_HAVE_MALLET_OF_THUNDEROUS_SKINS, // You already have a Mallet of Thunderous Skins.
    SPELL_CUSTOM_ERROR_CAN_ONLY_BE_USED_ON_INERT_TIDE_WATCHERS_OR_VOODOO_MASKS, // Can only be used on Inert Tide Watchers or Inert Voodoo Masks.
    SPELL_CUSTOM_ERROR_YOU_MUST_BE_AT_SHRINE_TO_MAKE_OFFERING_TO_LOA, // You must be at a Shrine to make an offering to a Loa.
    SPELL_CUSTOM_ERROR_REQUIRES_EMERALD_EMPOWERMENT, // Requires Emerald Empowerment.
    SPELL_CUSTOM_ERROR_YOU_MUST_BE_AN_HONORED_TAUREN, // You must be an honored tauren.
    SPELL_CUSTOM_ERROR_REQUIRES_CHITTERSPINE_MEAT, // Requires Chitterspine Meat.
    SPELL_CUSTOM_ERROR_REQUIRES_HEART_FORGE, // Requires Heart Forge.
    SPELL_CUSTOM_ERROR_NOT_AUTHORIZED_TO_ACCESS_CHARGING_STATION, // You are not authorized to access this Charging Station. Speak to Flux.
    SPELL_CUSTOM_ERROR_REQUIRES_MARDIVAS_ARCANE_COFFER, // Requires Mardivas's Arcane Coffer
    SPELL_CUSTOM_ERROR_REQUIRES_HEART_OF_AZEROTH_ATOP_HEART_FORGE, // Requires Heart of Azeroth placed atop Heart Forge.
    SPELL_CUSTOM_ERROR_REQUIRES_BRINESTONE_PICKAXE, // Requires a Brinestone Pickaxe.
    SPELL_CUSTOM_ERROR_YOU_ALREADY_COLLECTED_DATA_ON_THIS_TARGET, // You have already collected data on this target.
    SPELL_CUSTOM_ERROR_YOU_ALREADY_HAVE_THIS_ESSENCE_FOR_CURRENT_SPEC, // You already have this Essence for your current loot specialization
    SPELL_CUSTOM_ERROR_YOU_CANNOT_SUMMON_ANOTHER_PET_WHILE_RIDING_HATI, // You cannot summon another pet while riding Hati.
    SPELL_CUSTOM_ERROR_YOU_HAVE_ALREADY_COLLECTED_THIS_AZEROTH_MINI, // You have already collected this Azeroth Mini
    SPELL_CUSTOM_ERROR_YOUR_TARGET_IS_ALREADY_AFFECTED_BY_TEA_TIME, // Your target is already affected by Tea Time!
    SPELL_CUSTOM_ERROR_YOU_MUST_COMPLETE_QUEST_THE_HEART_FORGE_TO_INFUSE_ESSENCE, // You must complete the quest "The Heart Forge" to infuse an Essence
    SPELL_CUSTOM_ERROR_THIS_TARGET_DOES_NOT_HAVE_YOUR_RAZOR_CORAL, // This target does not have your Razor Coral.
    SPELL_CUSTOM_ERROR_YOU_DO_NOT_HAVE_ENOUGH_OF_THAT_ITEM, // You do not have enough of that item.
    SPELL_CUSTOM_ERROR_YOUR_TARGET_IS_NOT_WEARING_UNBOUND_CURSED_LOVERS_RING, // Your target is not wearing an unbound Cursed Lover's Ring
    SPELL_CUSTOM_ERROR_YOUR_CURSED_LOVERS_RING_IS_ALREDY_BOUND, // Your Cursed Lover's Ring is already bound
    SPELL_CUSTOM_ERROR_YOU_MUST_TARGET_A_NOTORIUS_GLADIATOR_ITEM, // You must target a Notorious Gladiator's item to upgrade.
    SPELL_CUSTOM_ERROR_YOU_CANT_CARRY_MORE_PICKAXES_CHUM_SEEDS, // You can't carry any more Brinestone Pickaxes, Chum, or Germinating Seeds.
    SPELL_CUSTOM_ERROR_REQUIRES_HOLIDAY_FEAST_OF_WINTER_WEIL, // Requires holiday: Feast of Winter Veil
    SPELL_CUSTOM_ERROR_REQUIRES_ASHJRAKAMAS_SHROUD_OF_RESOLVE, // Requires Ashjra'kamas, Shroud of Resolve.
    SPELL_CUSTOM_ERROR_REQUIRES_WAR_MODE, // Requires War Mode.
    SPELL_CUSTOM_ERROR_ONLY_ONE_OF_THIS_MASK_MAY_BE_WORN, // Only one of this mask may be worn.
    SPELL_CUSTOM_ERROR_YOU_CANNOT_ASCEND_WHILE_THE_TARRAGRUE_IS_NEARBY, // You cannot ascend while the Tarragrue is nearby.
    SPELL_CUSTOM_ERROR_TARGET_DOES_NOT_HAVE_A_VALID_AZERITE_ESSENCE, // Target does not have a valid Azerite Essence.
    SPELL_CUSTOM_ERROR_YOUR_MIND_IS_STILL_RECOVERING_FROM_RECENT_VISION, // Your mind is still recovering from a recent vision.
    SPELL_CUSTOM_ERROR_REQUIRES_VESSEL_OF_HORRIFIC_VISIONS, // Requires Vessel of Horrific Visions.
    SPELL_CUSTOM_ERROR_REQUIRES_ALL_PARTY_MEMBERS_TO_BE_WEARING_ASHJRAKAMAS_SHROUD_OF_RESOLVE, // Requires all party members to be wearing Ashjra'kamas, Shroud of Resolve.
    SPELL_CUSTOM_ERROR_REQUIRES_ALL_PARTY_MEMBERS_TO_POSSESS_A_VESSEL_OF_HORRIFIC_VISIONS, // Requires all party members to possess a Vessel of Horrific Visions.
    SPELL_CUSTOM_ERROR_YOU_ALREADY_HAVE_THE_HIGHEST_RANKED_ESSENCE_AVAILABLE_FROM_THIS_SOURCE, // You already have the highest ranked Essence available from this source.
    SPELL_CUSTOM_ERROR_REQUIRES_DARKMOON_GAME_TOKEN, // Requires Darkmoon Game Token.
    SPELL_CUSTOM_ERROR_YOU_ARE_NOT_THE_RIGHT_PROFESSION, // You are not the right profession.
    SPELL_CUSTOM_ERROR_YOU_ALREADY_KNOW_HOW_TO_CRAFT_A_VOID_FOCUS, // You already know how to craft a Void Focus.
    SPELL_CUSTOM_ERROR_YOU_ALREADY_KNOW_THE_RECIPES_IN_THIS_BOOK, // You already know the recipes in this book.
    SPELL_CUSTOM_ERROR_YOU_MUST_TARGET_A_CORRUPTED_GLADIATORS_ITEM, // You must target a Corrupted Gladiator's item to upgrade.
    SPELL_CUSTOM_ERROR_REQUIRES_THE_FIX_IT_STICK, // Requires the Fix-It-Stick.
    SPELL_CUSTOM_ERROR_THAT_ITEM_CANNOT_RECEIVE_ADDITIONAL_SOCKETS, // That item cannot receive additional sockets.
    SPELL_CUSTOM_ERROR_YOU_ALREADY_HAVE_A_CONTRACTED_VETERAN_TROOP, // You already have a contracted veteran troop.
    SPELL_CUSTOM_ERROR_YOU_ARE_CURRENTLY_AT_YOUR_TROOP_CAPACITY, // You are currently at your troop capacity.
    SPELL_CUSTOM_ERROR_YOU_DONT_HAVE_ENOUGH_ANIMA, // You don't have enough Anima
    SPELL_CUSTOM_ERROR_TARGET_ALREADY_HOLDING_VOID_TOUCHED_SKULL, // That player is already holding a void-touched skull.
    SPELL_CUSTOM_ERROR_TARGETS_INVENTORY_IS_FULL, // Target's inventory is full.
    SPELL_CUSTOM_ERROR_TARGETS_MIND_IS_PROTECTED_BY_NEURAL_SILENCER, // Your target's mind is protected by a neural silencer.
    SPELL_CUSTOM_ERROR_ALL_TARGETS_MINDS_ARE_PROTECTED_BY_NEURAL_SILENCERS, // All of your targets' minds are protected by neural silencers.
    SPELL_CUSTOM_ERROR_YOU_MUST_FIND_A_MORE_POWERFUL_CORE_TO_PROGRESS_YOUR_CLOAK_RANKS_FURTHER, // You must find a more powerful core to progress your cloak ranks further.
    SPELL_CUSTOM_ERROR_YOU_CANNOT_USE_THIS_ITEM_IN_WAR_MODE, // You cannot use this item in War Mode.
    SPELL_CUSTOM_ERROR_YOU_CANNOT_MAKE_YOUR_CAMP_HERE, // You cannot make your camp here.
    SPELL_CUSTOM_ERROR_REQUIRES_TITANIC_BEACON, // Requires Titanic Beacon
    SPELL_CUSTOM_ERROR_THAT_OBJECT_IS_LOCKED, // That Object is Locked.
    SPELL_CUSTOM_ERROR_INVALID_COMBINATION, // Invalid Combination.
    SPELL_CUSTOM_ERROR_NO_NEARBY_ENEMY_PLAYERS_ARE_CORRUPTED, // No nearby enemy players are corrupted.
    SPELL_CUSTOM_ERROR_THAT_SPELL_IS_ALREADY_ACTIVE, // That spell is already active
    SPELL_CUSTOM_ERROR_YOU_CANNOT_USE_THIS_WHEN_THE_TARRAGRUE_HAS_BEEN_ALERTED, // You cannot use this when the Tarragrue has been alerted.
    SPELL_CUSTOM_ERROR_THAT_GUEST_ALREADY_HAS_TEA, // That guest already has tea.
    SPELL_CUSTOM_ERROR_REQUIRES_SHADOWLANDS_SKINNING, // Requires Shadowlands Skinning.
    SPELL_CUSTOM_ERROR_REQUIRES_HUNTERS_MARK_ON_A_TARGET, // Requires Hunter's Mark on a target.
    SPELL_CUSTOM_ERROR_HOUNDMASTER_LOKSEY_IS_BUSY, // Houndmaster Loksey is busy.
    SPELL_CUSTOM_ERROR_REQUIRES_COIL_OF_ROPE, // Requires Coil of Rope.
    SPELL_CUSTOM_ERROR_MUST_BE_IN_A_REST_AREA, // Must be in a rest area.
    SPELL_CUSTOM_ERROR_TARGET_IS_LINKED_TO_SOMEBODY_ELSE, // Target is linked to somebody else.
    SPELL_CUSTOM_ERROR_YOU_DONT_HAVE_A_SUMMONED_GHOUL, // You don't have a summoned Ghoul.
    SPELL_CUSTOM_ERROR_ONE_OF_YOUR_PARTY_MEMBERS_IS_AN_INELIGIBLE_CLASS, // One of your party members is an ineligible class.
    SPELL_CUSTOM_ERROR_YOU_MUST_SELECT_A_SOULBIND_BOSS_AND_TIER_FIRST, // You must select a soulbind, boss, and tier first.
    SPELL_CUSTOM_ERROR_THAT_GUEST_DOESNT_WANT_THIS, // That guest doesn't want this.
    SPELL_CUSTOM_ERROR_YOU_MUST_DEFEAT_THE_EMPOWERED_GUARD_TO_ASCEND, // You must defeat the Empowered guard to ascend.
    SPELL_CUSTOM_ERROR_REQUIRES_SOULSTEEL_FORGE, // Requires Soulsteel Forge.
    SPELL_CUSTOM_ERROR_REQUIRES_PROOF_OF_PURITY, // Requires Proof of Purity
    SPELL_CUSTOM_ERROR_REQUIRES_PROOF_OF_HUMILITY, // Requires Proof of Humility
    SPELL_CUSTOM_ERROR_REQUIRES_PROOF_OF_COURAGE, // Requires Proof of Courage
    SPELL_CUSTOM_ERROR_REQUIRES_PROOF_OF_WISDOM, // Requires Proof of Wisdom
    SPELL_CUSTOM_ERROR_REQUIRES_PROOF_OF_LOYALTY, // Requires Proof of Loyalty
    SPELL_CUSTOM_ERROR_REQUIRES_ARCANE_SPECILIZATION, // Requires Arcane Specilization.
    SPELL_CUSTOM_ERROR_PLEASE_GATHER_YOUR_PARTY_BEFORE_QUEUING, // Please gather your party before queuing.
    SPELL_CUSTOM_ERROR_YOU_DO_NOT_KNOW_HOW_TO_TAME_GARGON, // You do not know how to tame Gargon.
    SPELL_CUSTOM_ERROR_REQUIRES_DEAD_SPRIGGAN, // Requires Dead Spriggan
    SPELL_CUSTOM_ERROR_YOU_ALREADY_USED_A_PROFESSION_JOURNAL_THIS_WEEK, // You have already used a Profession Journal this week.
    SPELL_CUSTOM_ERROR_REQUIRES_MORDRETHAR_THE_DEATH_GATE, // Requires Mord'rethar: The Death Gate.
    SPELL_CUSTOM_ERROR_REQUIRES_PLAGUEFALLEN, // Requires Plaguefallen
    SPELL_CUSTOM_ERROR_YOU_CANNOT_FIT_THROUGH_THERE, // You cannot fit through there.
    SPELL_CUSTOM_ERROR_A_BINDING_RITUAL_PREVENTS_THIS_FROM_OPENING, // A binding ritual prevents this from opening.
    SPELL_CUSTOM_ERROR_THAT_CHARM_IS_ALREADY_APPLIED, // That charm is already applied.
    SPELL_CUSTOM_ERROR_THAT_SIGIL_IS_ALREADY_APPLIED, // That sigil is already applied.
    SPELL_CUSTOM_ERROR_AT_LEAST_ONE_GUEST_MUST_RSVP_BEFORE_YOU_OPEN_COURT, // At least one guest must RSVP before you open court.
    SPELL_CUSTOM_ERROR_THERE_IS_NO_TIME_LIMIT_TO_INCREASE, // There is no time limit to increase.
    SPELL_CUSTOM_ERROR_YOUR_HEART_OF_AZEROTH_IS_CURRENTLY_DISABLED, // Your Heart of Azeroth is currently disabled.
    SPELL_CUSTOM_ERROR_ESSENCE_YOU_ARE_TRYING_TO_ACTIVATE_IS_INVALID, // The Essence you are trying to activate is invalid.
    SPELL_CUSTOM_ERROR_REQUIRES_MEDALLION_OF_SERVICE, // Requires Medallion of Service
    SPELL_CUSTOM_ERROR_ALL_PLAYERS_MUST_HAVE_QUEST_TORGHAST_TOWER_OF_THE_DAMNED, // All players must have quest - Torghast: Tower of the Damned.
    SPELL_CUSTOM_ERROR_REQUIRES_SHADOWLANDS_ENGINEERING, // Requires Shadowlands Engineering
    SPELL_CUSTOM_ERROR_YOU_ARE_NOT_IN_DEEP_ENOUGH_WATER, // You are not in deep enough water.
    SPELL_CUSTOM_ERROR_REQUIRES_FRESH_WATERS_OF_ARDENWEALD_OR_BASTION, // Requires the fresh waters of Ardenweald or Bastion
    SPELL_CUSTOM_ERROR_REQUIRES_30_INFUSED_RUBIES, // Requires 30 Infused Rubies
    SPELL_CUSTOM_ERROR_THE_CURSE_OF_TERAMANIKS_LEGACY_IS_KEEPING_YOUR_MOUNTS_FROM_HEEDING_YOUR_CALL, // The Curse of Teramanik's Legacy is keeping your mounts from heeding your call.
    SPELL_CUSTOM_ERROR_YOU_DO_NOT_KNOW_HOW_TO_TAME_CLOUD_SERPENTS, // You do not know how to tame Cloud Serpents.
    SPELL_CUSTOM_ERROR_YOU_DO_NOT_KNOW_HOW_TO_TAME_UNDEAD_CREATURES, // You do not know how to tame Undead creatures.
    SPELL_CUSTOM_ERROR_REQUIRES_THE_FORGE_OF_BONDS, // Requires the Forge of Bonds
    SPELL_CUSTOM_ERROR_REQUIRES_GATAMATOS, // Requires Gatamatos
    SPELL_CUSTOM_ERROR_MUST_BE_CHANNELLING_MIND_SEAR, // Must be channelling Mind Sear.
    SPELL_CUSTOM_ERROR_YOU_DONT_HAVE_ANY_PERIODIC_EFFECTS_ACTIVE, // You don't have any periodic effects active.
    SPELL_CUSTOM_ERROR_YOU_ARE_NOT_BEST_FRIENDS_WITH_ANY_EMBER_COURT_GUESTS, // You are not Best Friends with any Ember Court guests.
    SPELL_CUSTOM_ERROR_YOU_MUST_OBTAIN_VENOMOUS_SOLVENTS, // You must obtain Venomous Solvents.
    SPELL_CUSTOM_ERROR_YOU_MUST_OBTAIN_DREAD_POLLEN, // You must obtain Dread Pollen.
    SPELL_CUSTOM_ERROR_A_PARTY_MEMBER_DOES_NOT_HAVE_THAT_LAYER_UNLOCKED, // A party member does not have that layer unlocked
    SPELL_CUSTOM_ERROR_INVENTORY_IS_FULL, // Inventory is full.
    SPELL_CUSTOM_ERROR_YOU_HAVE_NO_ANIMA_TO_DEPOSIT, // You have no Anima to deposit
    SPELL_CUSTOM_ERROR_YOUR_MOUNT_IGNORES_YOUR_CALL_WITHIN_THE_MAW, // Your mount ignores your call within The Maw.
    SPELL_CUSTOM_ERROR_YOUR_BUTLER_IS_ALREADY_PRESENT_SOMEWHERE_IN_THE_EMBER_COURT, // Your butler is already present somewhere in the Ember Court.
    SPELL_CUSTOM_ERROR_YOU_HAVE_ALREADY_BUILT_THIS_CONSTRUCT, // You have already built this construct
    SPELL_CUSTOM_ERROR_REQUIRES_INNER_ALTAR_OF_DOMINATION, // Requires Inner Altar of Domination
    SPELL_CUSTOM_ERROR_PARTY_MEMBER_DOES_NOT_MEET_REQUIREMENTS_TO_QUEUE, // A party member does not meet the requirements to queue
    SPELL_CUSTOM_ERROR_NO_CONSTRUCT_CURRENTLY_ACTIVE, // No construct currently active
    SPELL_CUSTOM_ERROR_COMPLETE_THE_QUEST_LINE_WELCOME_TO_ZANDALAR, // Complete the quest line "Welcome to Zandalar" to use this spell.
    SPELL_CUSTOM_ERROR_COMPLETE_THE_QUEST_LINE_A_NATION_DIVIDED, // Complete the quest line "A Nation Divided" to use this spell.
    SPELL_CUSTOM_ERROR_CANNOT_BE_USED_ON_COMMON_QUALITY_ITEMS, // Cannot be used on Common quality items.
    SPELL_CUSTOM_ERROR_YOU_MUST_BE_PLEDGED_TO_THE_VENTHYR, // You must be pledged to the Venthyr.
    SPELL_CUSTOM_ERROR_YOU_MUST_BE_PLEDGED_TO_THE_NIGHT_FAE, // You must be pledged to the Night Fae.
    SPELL_CUSTOM_ERROR_YOU_MUST_BE_PLEDGED_TO_THE_KYRIAN, // You must be pledged to the Kyrian.
    SPELL_CUSTOM_ERROR_YOU_MUST_BE_PLEDGED_TO_THE_NECROLORDS, // You must be pledged to the Necrolords.
    SPELL_CUSTOM_ERROR_YOU_MUST_BE_IN_THE_SHADOWLANDS, // You must be in the Shadowlands.
    SPELL_CUSTOM_ERROR_REQUIRES_SANCTUM_RESERVOIR, // Requires Sanctum Reservoir.
    SPELL_CUSTOM_ERROR_THIS_WILDSEED_OF_REGROWTH_IS_STILL_INCUBATING, // This Wildseed of Regrowth is still incubating.
    SPELL_CUSTOM_ERROR_THIS_WILDSEED_OF_REGROWTH_IS_STILL_GROWING, // This Wildseed of Regrowth is still growing.
    SPELL_CUSTOM_ERROR_YOU_MUST_BE_PARTY_LEADER_TO_START_THIS_ESCORT, // You must be the party leader to start this escort.
    SPELL_CUSTOM_ERROR_YOU_HAVE_FULLY_UPGRADED_ALL_OF_YOUR_CONDUITS, // You have fully upgraded all of your Conduits.
    SPELL_CUSTOM_ERROR_YOU_HAVE_ALREADY_ADDED_THAT_CONDUIT, // You have already added that Conduit to the Forge of Bonds.
    SPELL_CUSTOM_ERROR_TARGET_MUST_BE_WEAKENED, // Target must be weakened.
    SPELL_CUSTOM_ERROR_YOU_CANNOT_ADD_THAT_CONDUIT_TO_FORGE_OF_BONDS, // You cannot add that Conduit to the Forge of Bonds.
    SPELL_CUSTOM_ERROR_YOU_CANNOT_SOULSHAPE_DURING_LICHBORNE, // You cannot Soulshape during Lichborne.
    SPELL_CUSTOM_ERROR_YOU_CANT_DO_THAT_WHILE_CARRYING_AN_ANIMACONE, // You can't do that while carrying an Animacone.
    SPELL_CUSTOM_ERROR_NECESSARY_CONSTRUCT_NOT_PRESENT, // Necessary construct not present.
    SPELL_CUSTOM_ERROR_THAT_GUEST_IS_ALREADY_COVERED_IN_GELATIN, // That guest is already covered in gelatin.
    SPELL_CUSTOM_ERROR_YOU_NEED_TO_WAIT_TO_USE_THIS_ITEM, // You need to wait to use this item.
}
