...
public enum SkillType {
    ...
    SkillType skillByLockType(LockType locktype) {
        switch (locktype) {
            ...
            case LOCKTYPE_CLASSIC_HERBALISM:
                return SKILL_HERBALISM_2;
            case LOCKTYPE_OUTLAND_HERBALISM:
                return SKILL_OUTLAND_HERBALISM;
            case LOCKTYPE_NORTHREND_HERBALISM:
                return SKILL_NORTHREND_HERBALISM;
            case LOCKTYPE_CATACLYSM_HERBALISM:
                return SKILL_CATACLYSM_HERBALISM;
            case LOCKTYPE_PANDARIA_HERBALISM:
                return SKILL_PANDARIA_HERBALISM;
            case LOCKTYPE_DRAENOR_HERBALISM:
                return SKILL_DRAENOR_HERBALISM;
            case LOCKTYPE_LEGION_HERBALISM:
                return SKILL_LEGION_HERBALISM;
            case LOCKTYPE_KUL_TIRAN_HERBALISM:
                return SKILL_KUL_TIRAN_HERBALISM;
            case LOCKTYPE_CLASSIC_MINING:
                return SKILL_MINING_2;
            case LOCKTYPE_OUTLAND_MINING:
                return SKILL_OUTLAND_MINING;
            case LOCKTYPE_NORTHREND_MINING:
                return SKILL_NORTHREND_MINING;
            case LOCKTYPE_CATACLYSM_MINING:
                return SKILL_CATACLYSM_MINING;
            case LOCKTYPE_PANDARIA_MINING:
                return SKILL_PANDARIA_MINING;
            case LOCKTYPE_DRAENOR_MINING:
                return SKILL_DRAENOR_MINING;
            case LOCKTYPE_LEGION_MINING:
                return SKILL_LEGION_MINING;
            case LOCKTYPE_KUL_TIRAN_MINING:
                return SKILL_KUL_TIRAN_MINING;
            default:
                break;
        }
        return SKILL_NONE;
    ...
    int skillByQuestSort(QuestSort questSort) {
        return switch (questSort) {
            case QUEST_SORT_HERBALISM -> SKILL_HERBALISM.val();
            case QUEST_SORT_FISHING -> SKILL_FISHING.val();
            case QUEST_SORT_BLACKSMITHING -> SKILL_BLACKSMITHING.val();
            case QUEST_SORT_ALCHEMY -> SKILL_ALCHEMY.val();
            case QUEST_SORT_LEATHERWORKING -> SKILL_LEATHERWORKING.val();
            case QUEST_SORT_ENGINEERING -> SKILL_ENGINEERING.val();
            case QUEST_SORT_TAILORING -> SKILL_TAILORING.val();
            case QUEST_SORT_COOKING -> SKILL_COOKING.val();
            case QUEST_SORT_JEWELCRAFTING -> SKILL_JEWELCRAFTING.val();
            case QUEST_SORT_INSCRIPTION -> SKILL_INSCRIPTION.val();
            case QUEST_SORT_ARCHAEOLOGY -> SKILL_ARCHAEOLOGY.val();
            default -> 0;
        };
    }
}
