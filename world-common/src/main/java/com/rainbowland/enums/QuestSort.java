...
public enum QuestSort {
    ...
    Classes classByQuestSort(QuestSort questSort) {
        return switch (questSort) {
            case QUEST_SORT_WARLOCK -> Classes.CLASS_WARLOCK;
            case QUEST_SORT_WARRIOR -> Classes.CLASS_WARRIOR;
            case QUEST_SORT_SHAMAN -> Classes.CLASS_SHAMAN;
            case QUEST_SORT_PALADIN -> Classes.CLASS_PALADIN;
            case QUEST_SORT_MAGE -> Classes.CLASS_MAGE;
            case QUEST_SORT_ROGUE -> Classes.CLASS_ROGUE;
            case QUEST_SORT_HUNTER -> Classes.CLASS_HUNTER;
            case QUEST_SORT_PRIEST -> Classes.CLASS_PRIEST;
            case QUEST_SORT_DRUID -> Classes.CLASS_DRUID;
            case QUEST_SORT_DEATH_KNIGHT -> Classes.CLASS_DEATH_KNIGHT;
            case QUEST_SORT_DEMON_HUNTER -> Classes.CLASS_DEMON_HUNTER;
            default -> Classes.CLASS_NONE;
        };
    }
}
