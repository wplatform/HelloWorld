package com.github.mmo.world;

import com.github.mmo.common.Locale;
import com.github.mmo.dbc.DbcObjectManager;
import com.github.mmo.world.entities.object.enums.HighGuid;
...
public class World {
    ...
    public World(WorldConfiguration configuration) {
        partition = new com.github.mmo.world.test.World.WorldSegment(configuration);
    ...
    public <T extends com.github.mmo.world.test.Component> ComponentMapper<T> getMapper(Class<T> type) {
