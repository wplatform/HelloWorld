...
import com.github.mmo.game.service.domain.PlayerCreateInfoAction;
import com.github.mmo.game.service.domain.PlayerCreateInfoItem;
...
public class PlayerInfo
{
	...
	public final static class CreatePositionModel
	{
		...
		public CreatePositionModel clone()
		{
			CreatePositionModel varCopy = new createPositionModel();

			varCopy.loc = this.loc;
			varCopy.transportGuid = this.transportGuid;
