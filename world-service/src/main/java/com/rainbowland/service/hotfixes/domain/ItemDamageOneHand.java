...
public class ItemDamageOneHand {
    ...
    @ReadingConverter
    public static class RowMapper implements Converter<Row, ItemDamageOneHand> {

        public ItemDamageOneHand convert(Row row) {
            ItemDamageOneHand domain = new ItemDamageOneHand();
    ...
    @WritingConverter
    public static class ParamMapper implements Converter<ItemDamageOneHand, OutboundRow> {

        public OutboundRow convert(ItemDamageOneHand source) {
