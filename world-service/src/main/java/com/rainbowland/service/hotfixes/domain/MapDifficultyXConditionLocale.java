...
public class MapDifficultyXConditionLocale {
    ...
    @ReadingConverter
    public static class RowMapper implements Converter<Row, MapDifficultyXConditionLocale> {

        public MapDifficultyXConditionLocale convert(Row row) {
            MapDifficultyXConditionLocale domain = new MapDifficultyXConditionLocale();
    ...
    @WritingConverter
    public static class ParamMapper implements Converter<MapDifficultyXConditionLocale, OutboundRow> {

        public OutboundRow convert(MapDifficultyXConditionLocale source) {
