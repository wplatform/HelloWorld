...
public class UiMapLocale {
    ...
    @ReadingConverter
    public static class RowMapper implements Converter<Row, UiMapLocale> {

        public UiMapLocale convert(Row row) {
            UiMapLocale domain = new UiMapLocale();
    ...
    @WritingConverter
    public static class ParamMapper implements Converter<UiMapLocale, OutboundRow> {

        public OutboundRow convert(UiMapLocale source) {
