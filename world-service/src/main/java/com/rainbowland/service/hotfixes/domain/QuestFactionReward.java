...
public class QuestFactionReward {
    ...
    @ReadingConverter
    public static class RowMapper implements Converter<Row, QuestFactionReward> {

        public QuestFactionReward convert(Row row) {
            QuestFactionReward domain = new QuestFactionReward();
    ...
    @WritingConverter
    public static class ParamMapper implements Converter<QuestFactionReward, OutboundRow> {

        public OutboundRow convert(QuestFactionReward source) {
