...
public class LfgDungeonsLocale {
    ...
    @ReadingConverter
    public static class RowMapper implements Converter<Row, LfgDungeonsLocale> {

        public LfgDungeonsLocale convert(Row row) {
            LfgDungeonsLocale domain = new LfgDungeonsLocale();
    ...
    @WritingConverter
    public static class ParamMapper implements Converter<LfgDungeonsLocale, OutboundRow> {

        public OutboundRow convert(LfgDungeonsLocale source) {
