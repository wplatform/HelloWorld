...
public class CurrencyTypesLocale {
    ...
    @ReadingConverter
    public static class RowMapper implements Converter<Row, CurrencyTypesLocale> {

        public CurrencyTypesLocale convert(Row row) {
            CurrencyTypesLocale domain = new CurrencyTypesLocale();
    ...
    @WritingConverter
    public static class ParamMapper implements Converter<CurrencyTypesLocale, OutboundRow> {

        public OutboundRow convert(CurrencyTypesLocale source) {
