...
public class CriteriaTreeLocale {
    ...
    @ReadingConverter
    public static class RowMapper implements Converter<Row, CriteriaTreeLocale> {

        public CriteriaTreeLocale convert(Row row) {
            CriteriaTreeLocale domain = new CriteriaTreeLocale();
    ...
    @WritingConverter
    public static class ParamMapper implements Converter<CriteriaTreeLocale, OutboundRow> {

        public OutboundRow convert(CriteriaTreeLocale source) {
