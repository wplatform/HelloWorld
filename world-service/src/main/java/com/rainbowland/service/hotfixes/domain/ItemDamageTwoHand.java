...
public class ItemDamageTwoHand {
    ...
    @ReadingConverter
    public static class RowMapper implements Converter<Row, ItemDamageTwoHand> {

        public ItemDamageTwoHand convert(Row row) {
            ItemDamageTwoHand domain = new ItemDamageTwoHand();
    ...
    @WritingConverter
    public static class ParamMapper implements Converter<ItemDamageTwoHand, OutboundRow> {

        public OutboundRow convert(ItemDamageTwoHand source) {
