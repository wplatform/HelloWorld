...
public class SpellItemEnchantmentLocale {
    ...
    @ReadingConverter
    public static class RowMapper implements Converter<Row, SpellItemEnchantmentLocale> {

        public SpellItemEnchantmentLocale convert(Row row) {
            SpellItemEnchantmentLocale domain = new SpellItemEnchantmentLocale();
    ...
    @WritingConverter
    public static class ParamMapper implements Converter<SpellItemEnchantmentLocale, OutboundRow> {

        public OutboundRow convert(SpellItemEnchantmentLocale source) {
