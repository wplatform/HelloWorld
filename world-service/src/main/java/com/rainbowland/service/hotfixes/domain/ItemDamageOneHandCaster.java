...
public class ItemDamageOneHandCaster {
    ...
    @ReadingConverter
    public static class RowMapper implements Converter<Row, ItemDamageOneHandCaster> {

        public ItemDamageOneHandCaster convert(Row row) {
            ItemDamageOneHandCaster domain = new ItemDamageOneHandCaster();
    ...
    @WritingConverter
    public static class ParamMapper implements Converter<ItemDamageOneHandCaster, OutboundRow> {

        public OutboundRow convert(ItemDamageOneHandCaster source) {
