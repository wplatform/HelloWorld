...
public class SpellFocusObjectLocale {
    ...
    @ReadingConverter
    public static class RowMapper implements Converter<Row, SpellFocusObjectLocale> {

        public SpellFocusObjectLocale convert(Row row) {
            SpellFocusObjectLocale domain = new SpellFocusObjectLocale();
    ...
    @WritingConverter
    public static class ParamMapper implements Converter<SpellFocusObjectLocale, OutboundRow> {

        public OutboundRow convert(SpellFocusObjectLocale source) {
