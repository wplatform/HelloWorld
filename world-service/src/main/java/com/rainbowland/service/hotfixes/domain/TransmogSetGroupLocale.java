...
public class TransmogSetGroupLocale {
    ...
    @ReadingConverter
    public static class RowMapper implements Converter<Row, TransmogSetGroupLocale> {

        public TransmogSetGroupLocale convert(Row row) {
            TransmogSetGroupLocale domain = new TransmogSetGroupLocale();
    ...
    @WritingConverter
    public static class ParamMapper implements Converter<TransmogSetGroupLocale, OutboundRow> {

        public OutboundRow convert(TransmogSetGroupLocale source) {
