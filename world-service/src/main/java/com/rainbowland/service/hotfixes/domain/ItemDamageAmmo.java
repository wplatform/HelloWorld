...
public class ItemDamageAmmo {
    ...
    @ReadingConverter
    public static class RowMapper implements Converter<Row, ItemDamageAmmo> {

        public ItemDamageAmmo convert(Row row) {
            ItemDamageAmmo domain = new ItemDamageAmmo();
    ...
    @WritingConverter
    public static class ParamMapper implements Converter<ItemDamageAmmo, OutboundRow> {

        public OutboundRow convert(ItemDamageAmmo source) {
