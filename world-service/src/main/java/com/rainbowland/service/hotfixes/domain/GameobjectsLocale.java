...
public class GameobjectsLocale {
    ...
    @ReadingConverter
    public static class RowMapper implements Converter<Row, GameobjectsLocale> {

        public GameobjectsLocale convert(Row row) {
            GameobjectsLocale domain = new GameobjectsLocale();
    ...
    @WritingConverter
    public static class ParamMapper implements Converter<GameobjectsLocale, OutboundRow> {

        public OutboundRow convert(GameobjectsLocale source) {
