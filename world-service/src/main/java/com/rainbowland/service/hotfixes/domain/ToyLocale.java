...
public class ToyLocale {
    ...
    @ReadingConverter
    public static class RowMapper implements Converter<Row, ToyLocale> {

        public ToyLocale convert(Row row) {
            ToyLocale domain = new ToyLocale();
    ...
    @WritingConverter
    public static class ParamMapper implements Converter<ToyLocale, OutboundRow> {

        public OutboundRow convert(ToyLocale source) {
