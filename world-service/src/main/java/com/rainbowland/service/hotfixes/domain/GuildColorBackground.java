...
public class GuildColorBackground {
    ...
    @ReadingConverter
    public static class RowMapper implements Converter<Row, GuildColorBackground> {

        public GuildColorBackground convert(Row row) {
            GuildColorBackground domain = new GuildColorBackground();
    ...
    @WritingConverter
    public static class ParamMapper implements Converter<GuildColorBackground, OutboundRow> {

        public OutboundRow convert(GuildColorBackground source) {
