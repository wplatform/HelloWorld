...
public class TalentLocale {
    ...
    @ReadingConverter
    public static class RowMapper implements Converter<Row, TalentLocale> {

        public TalentLocale convert(Row row) {
            TalentLocale domain = new TalentLocale();
    ...
    @WritingConverter
    public static class ParamMapper implements Converter<TalentLocale, OutboundRow> {

        public OutboundRow convert(TalentLocale source) {
