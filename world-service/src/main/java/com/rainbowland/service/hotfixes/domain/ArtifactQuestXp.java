...
public class ArtifactQuestXp {
    ...
    @ReadingConverter
    public static class RowMapper implements Converter<Row, ArtifactQuestXp> {

        public ArtifactQuestXp convert(Row row) {
            ArtifactQuestXp domain = new ArtifactQuestXp();
    ...
    @WritingConverter
    public static class ParamMapper implements Converter<ArtifactQuestXp, OutboundRow> {

        public OutboundRow convert(ArtifactQuestXp source) {
