...
public class AzeriteEssenceLocale {
    ...
    @ReadingConverter
    public static class RowMapper implements Converter<Row, AzeriteEssenceLocale> {

        public AzeriteEssenceLocale convert(Row row) {
            AzeriteEssenceLocale domain = new AzeriteEssenceLocale();
    ...
    @WritingConverter
    public static class ParamMapper implements Converter<AzeriteEssenceLocale, OutboundRow> {

        public OutboundRow convert(AzeriteEssenceLocale source) {
