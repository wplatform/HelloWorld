...
public class QuestMoneyReward {
    ...
    @ReadingConverter
    public static class RowMapper implements Converter<Row, QuestMoneyReward> {

        public QuestMoneyReward convert(Row row) {
            QuestMoneyReward domain = new QuestMoneyReward();
    ...
    @WritingConverter
    public static class ParamMapper implements Converter<QuestMoneyReward, OutboundRow> {

        public OutboundRow convert(QuestMoneyReward source) {
