...
public class GarrAbilityLocale {
    ...
    @ReadingConverter
    public static class RowMapper implements Converter<Row, GarrAbilityLocale> {

        public GarrAbilityLocale convert(Row row) {
            GarrAbilityLocale domain = new GarrAbilityLocale();
    ...
    @WritingConverter
    public static class ParamMapper implements Converter<GarrAbilityLocale, OutboundRow> {

        public OutboundRow convert(GarrAbilityLocale source) {
