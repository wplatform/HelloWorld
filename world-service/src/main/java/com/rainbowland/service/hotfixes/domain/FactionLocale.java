...
public class FactionLocale {
    ...
    @ReadingConverter
    public static class RowMapper implements Converter<Row, FactionLocale> {

        public FactionLocale convert(Row row) {
            FactionLocale domain = new FactionLocale();
    ...
    @WritingConverter
    public static class ParamMapper implements Converter<FactionLocale, OutboundRow> {

        public OutboundRow convert(FactionLocale source) {
