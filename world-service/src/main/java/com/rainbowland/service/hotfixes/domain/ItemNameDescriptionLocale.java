...
public class ItemNameDescriptionLocale {
    ...
    @ReadingConverter
    public static class RowMapper implements Converter<Row, ItemNameDescriptionLocale> {

        public ItemNameDescriptionLocale convert(Row row) {
            ItemNameDescriptionLocale domain = new ItemNameDescriptionLocale();
    ...
    @WritingConverter
    public static class ParamMapper implements Converter<ItemNameDescriptionLocale, OutboundRow> {

        public OutboundRow convert(ItemNameDescriptionLocale source) {
