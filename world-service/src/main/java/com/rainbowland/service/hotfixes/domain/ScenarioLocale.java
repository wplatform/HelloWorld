...
public class ScenarioLocale {
    ...
    @ReadingConverter
    public static class RowMapper implements Converter<Row, ScenarioLocale> {

        public ScenarioLocale convert(Row row) {
            ScenarioLocale domain = new ScenarioLocale();
    ...
    @WritingConverter
    public static class ParamMapper implements Converter<ScenarioLocale, OutboundRow> {

        public OutboundRow convert(ScenarioLocale source) {
