...
public class SpellCategoryLocale {
    ...
    @ReadingConverter
    public static class RowMapper implements Converter<Row, SpellCategoryLocale> {

        public SpellCategoryLocale convert(Row row) {
            SpellCategoryLocale domain = new SpellCategoryLocale();
    ...
    @WritingConverter
    public static class ParamMapper implements Converter<SpellCategoryLocale, OutboundRow> {

        public OutboundRow convert(SpellCategoryLocale source) {
