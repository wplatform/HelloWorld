...
public class PoolCreature {
    ...
    @ReadingConverter
    public static class RowMapper implements Converter<Row, PoolCreature> {

        public PoolCreature convert(Row row) {
            PoolCreature domain = new PoolCreature();
    ...
    @WritingConverter
    public static class ParamMapper implements Converter<PoolCreature, OutboundRow> {

        public OutboundRow convert(PoolCreature source) {
