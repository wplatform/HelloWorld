...
public class QuestDetails {
    ...
    @ReadingConverter
    public static class RowMapper implements Converter<Row, QuestDetails> {

        public QuestDetails convert(Row row) {
            QuestDetails domain = new QuestDetails();
    ...
    @WritingConverter
    public static class ParamMapper implements Converter<QuestDetails, OutboundRow> {

        public OutboundRow convert(QuestDetails source) {
