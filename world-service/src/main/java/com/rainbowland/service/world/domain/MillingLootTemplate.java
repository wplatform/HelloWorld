...
public class MillingLootTemplate {
    ...
    @ReadingConverter
    public static class RowMapper implements Converter<Row, MillingLootTemplate> {

        public MillingLootTemplate convert(Row row) {
            MillingLootTemplate domain = new MillingLootTemplate();
    ...
    @WritingConverter
    public static class ParamMapper implements Converter<MillingLootTemplate, OutboundRow> {

        public OutboundRow convert(MillingLootTemplate source) {
