...
public class CreatureTemplateAddon {
    ...
    @ReadingConverter
    public static class RowMapper implements Converter<Row, CreatureTemplateAddon> {

        public CreatureTemplateAddon convert(Row row) {
            CreatureTemplateAddon domain = new CreatureTemplateAddon();
    ...
    @WritingConverter
    public static class ParamMapper implements Converter<CreatureTemplateAddon, OutboundRow> {

        public OutboundRow convert(CreatureTemplateAddon source) {
