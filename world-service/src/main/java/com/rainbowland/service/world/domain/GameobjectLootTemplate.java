...
public class GameobjectLootTemplate {
    ...
    @ReadingConverter
    public static class RowMapper implements Converter<Row, GameobjectLootTemplate> {

        public GameobjectLootTemplate convert(Row row) {
            GameobjectLootTemplate domain = new GameobjectLootTemplate();
    ...
    @WritingConverter
    public static class ParamMapper implements Converter<GameobjectLootTemplate, OutboundRow> {

        public OutboundRow convert(GameobjectLootTemplate source) {
