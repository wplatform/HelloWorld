...
public class SkinningLootTemplate {
    ...
    @ReadingConverter
    public static class RowMapper implements Converter<Row, SkinningLootTemplate> {

        public SkinningLootTemplate convert(Row row) {
            SkinningLootTemplate domain = new SkinningLootTemplate();
    ...
    @WritingConverter
    public static class ParamMapper implements Converter<SkinningLootTemplate, OutboundRow> {

        public OutboundRow convert(SkinningLootTemplate source) {
