...
public class ServersideSpellEffect {
    ...
    @ReadingConverter
    public static class RowMapper implements Converter<Row, ServersideSpellEffect> {

        public ServersideSpellEffect convert(Row row) {
            ServersideSpellEffect domain = new ServersideSpellEffect();
    ...
    @WritingConverter
    public static class ParamMapper implements Converter<ServersideSpellEffect, OutboundRow> {

        public OutboundRow convert(ServersideSpellEffect source) {
