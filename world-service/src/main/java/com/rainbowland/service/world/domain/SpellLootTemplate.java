...
public class SpellLootTemplate {
    ...
    @ReadingConverter
    public static class RowMapper implements Converter<Row, SpellLootTemplate> {

        public SpellLootTemplate convert(Row row) {
            SpellLootTemplate domain = new SpellLootTemplate();
    ...
    @WritingConverter
    public static class ParamMapper implements Converter<SpellLootTemplate, OutboundRow> {

        public OutboundRow convert(SpellLootTemplate source) {
