...
public class PlayerchoiceResponseRewardItemChoice {
    ...
    @ReadingConverter
    public static class RowMapper implements Converter<Row, PlayerchoiceResponseRewardItemChoice> {

        public PlayerchoiceResponseRewardItemChoice convert(Row row) {
            PlayerchoiceResponseRewardItemChoice domain = new PlayerchoiceResponseRewardItemChoice();
    ...
    @WritingConverter
    public static class ParamMapper implements Converter<PlayerchoiceResponseRewardItemChoice, OutboundRow> {

        public OutboundRow convert(PlayerchoiceResponseRewardItemChoice source) {
