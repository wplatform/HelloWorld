...
public class QuestRequestItemsLocale {
    ...
    @ReadingConverter
    public static class RowMapper implements Converter<Row, QuestRequestItemsLocale> {

        public QuestRequestItemsLocale convert(Row row) {
            QuestRequestItemsLocale domain = new QuestRequestItemsLocale();
    ...
    @WritingConverter
    public static class ParamMapper implements Converter<QuestRequestItemsLocale, OutboundRow> {

        public OutboundRow convert(QuestRequestItemsLocale source) {
