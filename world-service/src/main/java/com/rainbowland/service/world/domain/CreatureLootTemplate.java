...
public class CreatureLootTemplate {
    ...
    @ReadingConverter
    public static class RowMapper implements Converter<Row, CreatureLootTemplate> {

        public CreatureLootTemplate convert(Row row) {
            CreatureLootTemplate domain = new CreatureLootTemplate();
    ...
    @WritingConverter
    public static class ParamMapper implements Converter<CreatureLootTemplate, OutboundRow> {

        public OutboundRow convert(CreatureLootTemplate source) {
