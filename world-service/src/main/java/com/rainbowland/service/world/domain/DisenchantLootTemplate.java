...
public class DisenchantLootTemplate {
    ...
    @ReadingConverter
    public static class RowMapper implements Converter<Row, DisenchantLootTemplate> {

        public DisenchantLootTemplate convert(Row row) {
            DisenchantLootTemplate domain = new DisenchantLootTemplate();
    ...
    @WritingConverter
    public static class ParamMapper implements Converter<DisenchantLootTemplate, OutboundRow> {

        public OutboundRow convert(DisenchantLootTemplate source) {
