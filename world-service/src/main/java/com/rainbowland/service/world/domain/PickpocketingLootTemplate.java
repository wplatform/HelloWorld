...
public class PickpocketingLootTemplate {
    ...
    @ReadingConverter
    public static class RowMapper implements Converter<Row, PickpocketingLootTemplate> {

        public PickpocketingLootTemplate convert(Row row) {
            PickpocketingLootTemplate domain = new PickpocketingLootTemplate();
    ...
    @WritingConverter
    public static class ParamMapper implements Converter<PickpocketingLootTemplate, OutboundRow> {

        public OutboundRow convert(PickpocketingLootTemplate source) {
