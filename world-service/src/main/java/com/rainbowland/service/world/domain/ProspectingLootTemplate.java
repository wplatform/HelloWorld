...
public class ProspectingLootTemplate {
    ...
    @ReadingConverter
    public static class RowMapper implements Converter<Row, ProspectingLootTemplate> {

        public ProspectingLootTemplate convert(Row row) {
            ProspectingLootTemplate domain = new ProspectingLootTemplate();
    ...
    @WritingConverter
    public static class ParamMapper implements Converter<ProspectingLootTemplate, OutboundRow> {

        public OutboundRow convert(ProspectingLootTemplate source) {
