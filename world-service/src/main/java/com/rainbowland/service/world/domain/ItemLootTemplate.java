...
public class ItemLootTemplate {
    ...
    @ReadingConverter
    public static class RowMapper implements Converter<Row, ItemLootTemplate> {

        public ItemLootTemplate convert(Row row) {
            ItemLootTemplate domain = new ItemLootTemplate();
    ...
    @WritingConverter
    public static class ParamMapper implements Converter<ItemLootTemplate, OutboundRow> {

        public OutboundRow convert(ItemLootTemplate source) {
