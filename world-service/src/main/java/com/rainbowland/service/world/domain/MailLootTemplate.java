...
public class MailLootTemplate {
    ...
    @ReadingConverter
    public static class RowMapper implements Converter<Row, MailLootTemplate> {

        public MailLootTemplate convert(Row row) {
            MailLootTemplate domain = new MailLootTemplate();
    ...
    @WritingConverter
    public static class ParamMapper implements Converter<MailLootTemplate, OutboundRow> {

        public OutboundRow convert(MailLootTemplate source) {
