...
public class FishingLootTemplate {
    ...
    @ReadingConverter
    public static class RowMapper implements Converter<Row, FishingLootTemplate> {

        public FishingLootTemplate convert(Row row) {
            FishingLootTemplate domain = new FishingLootTemplate();
    ...
    @WritingConverter
    public static class ParamMapper implements Converter<FishingLootTemplate, OutboundRow> {

        public OutboundRow convert(FishingLootTemplate source) {
