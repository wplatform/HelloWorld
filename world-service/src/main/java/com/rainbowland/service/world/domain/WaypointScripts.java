...
public class WaypointScripts {
    ...
    @ReadingConverter
    public static class RowMapper implements Converter<Row, WaypointScripts> {

        public WaypointScripts convert(Row row) {
            WaypointScripts domain = new WaypointScripts();
    ...
    @WritingConverter
    public static class ParamMapper implements Converter<WaypointScripts, OutboundRow> {

        public OutboundRow convert(WaypointScripts source) {
