...
public class PetAuraEffect {
    ...
    @ReadingConverter
    public static class RowMapper implements Converter<Row, PetAuraEffect> {

        public PetAuraEffect convert(Row row) {
            PetAuraEffect domain = new PetAuraEffect();
    ...
    @WritingConverter
    public static class ParamMapper implements Converter<PetAuraEffect, OutboundRow> {

        public OutboundRow convert(PetAuraEffect source) {
