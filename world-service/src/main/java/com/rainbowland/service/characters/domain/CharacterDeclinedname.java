...
public class CharacterDeclinedname {
    ...
    @ReadingConverter
    public static class RowMapper implements Converter<Row, CharacterDeclinedname> {

        public CharacterDeclinedname convert(Row row) {
            CharacterDeclinedname domain = new CharacterDeclinedname();
    ...
    @WritingConverter
    public static class ParamMapper implements Converter<CharacterDeclinedname, OutboundRow> {

        public OutboundRow convert(CharacterDeclinedname source) {
