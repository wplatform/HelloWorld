...
public class GmSuggestion {
    ...
    @ReadingConverter
    public static class RowMapper implements Converter<Row, GmSuggestion> {

        public GmSuggestion convert(Row row) {
            GmSuggestion domain = new GmSuggestion();
    ...
    @WritingConverter
    public static class ParamMapper implements Converter<GmSuggestion, OutboundRow> {

        public OutboundRow convert(GmSuggestion source) {
