...
public class IpBanned {
    ...
    @ReadingConverter
    public static class RowMapper implements Converter<Row, IpBanned> {

        public IpBanned convert(Row row) {
            IpBanned domain = new IpBanned();
    ...
    @WritingConverter
    public static class ParamMapper implements Converter<IpBanned, OutboundRow> {

        public OutboundRow convert(IpBanned source) {
